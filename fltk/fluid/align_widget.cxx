//
// "$Id: align_widget.cxx 6614 2009-01-01 16:11:32Z matt $"
//
...
void align_widget_cb(Fl_Widget*, long how)
{
  ...
  //case 3000: // fill parent width same size
	...
	if (o->selected && o->is_widget())
	{
	  ...
	  Fl_Widget *w = ((Fl_Widget_Type *)o)->o;
	  use_x = use_parent ? (parent_is_window ? 0 : w->parent()->x()) : w->x();
	  if (o->next && o->next->level > o->level && !o->next->selected &&
	      !o->is_menu_button()) {
	    // When resizing a group, make sure we also move the children...
  ...
  //case 3100: // fill parent same parent height
	...
	if (o->selected && o->is_widget())
	{
	  ...
	  Fl_Widget *w = ((Fl_Widget_Type *)o)->o;
	  use_y = use_parent ? (parent_is_window ? 0 : w->parent()->y()) : w->y();
	  if (o->next && o->next->level > o->level && !o->next->selected &&
	      !o->is_menu_button()) {
	    // When resizing a group, make sure we also move the children...
...
//
// End of "$Id: align_widget.cxx 6614 2009-01-01 16:11:32Z matt $".
//
