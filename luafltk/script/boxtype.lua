...
-- these functions must run before the box types will work
...
_FL_GTK_UP_BOX = 38,
_FL_GTK_DOWN_BOX = 39,
_FL_GTK_THIN_UP_BOX = 42,
_FL_GTK_THIN_DOWN_BOX = 43,
_FL_GTK_ROUND_UP_BOX = 46,
_FL_GTK_ROUND_DOWN_BOX = 47
]]
...
_FL_SHADOW_BOX = fltk._FL_SHADOW_BOX,
_FL_ROUNDED_BOX = fltk._FL_ROUNDED_BOX,
_FL_RSHADOW_BOX = fltk._FL_RSHADOW_BOX,
_FL_RFLAT_BOX = fltk._FL_RFLAT_BOX,
_FL_ROUND_UP_BOX = fltk._FL_ROUND_UP_BOX,
_FL_ROUND_DOWN_BOX = fltk._FL_ROUND_DOWN_BOX,
_FL_DIAMOND_UP_BOX = fltk._FL_DIAMOND_UP_BOX,
_FL_DIAMOND_DOWN_BOX = fltk._FL_DIAMOND_DOWN_BOX,
_FL_OVAL_BOX = fltk._FL_OVAL_BOX,
_FL_OSHADOW_BOX = fltk._FL_OSHADOW_BOX,
_FL_OFLAT_BOX = fltk._FL_OFLAT_BOX,
_FL_PLASTIC_UP_BOX = fltk._FL_PLASTIC_UP_BOX,
_FL_PLASTIC_DOWN_BOX = fltk._FL_PLASTIC_DOWN_BOX,
_FL_PLASTIC_THIN_UP_BOX = fltk._FL_PLASTIC_THIN_UP_BOX,
_FL_PLASTIC_THIN_DOWN_BOX = fltk._FL_PLASTIC_THIN_DOWN_BOX,
_FL_PLASTIC_ROUND_UP_BOX = fltk._FL_PLASTIC_ROUND_UP_BOX,
_FL_PLASTIC_ROUND_DOWN_BOX = fltk._FL_PLASTIC_ROUND_DOWN_BOX,
_FL_GTK_UP_BOX = fltk._FL_GTK_UP_BOX,
_FL_GTK_DOWN_BOX = fltk._FL_GTK_DOWN_BOX,
_FL_GTK_THIN_UP_BOX = fltk._FL_GTK_THIN_UP_BOX,
_FL_GTK_THIN_DOWN_BOX = fltk._FL_GTK_THIN_DOWN_BOX,
_FL_GTK_ROUND_UP_BOX = fltk._FL_GTK_ROUND_UP_BOX,
_FL_GTK_ROUND_DOWN_BOX = fltk._FL_GTK_ROUND_DOWN_BOX,
_FL_SHADOW_FRAME = fltk._FL_SHADOW_FRAME,
_FL_ROUNDED_FRAME = fltk._FL_ROUNDED_FRAME,
_FL_OVAL_FRAME = fltk._FL_OVAL_FRAME,
_FL_PLASTIC_UP_FRAME = fltk._FL_PLASTIC_UP_FRAME,
_FL_PLASTIC_DOWN_FRAME = fltk._FL_PLASTIC_DOWN_FRAME,
}

my_scroll=fltk.Fl_Scroll:new(10,10,400,300)
fltk.Fl_End()
...
type_butts[v] = fltk.Fl_Button:new(20,cnt,80,25,k.." ("..v..")")
type_butts[v]:box(v)
