//
// "$Id: Fl_Window_Type.cxx 7152 2010-02-26 13:40:10Z matt $"
//
...
void Fl_Window_Type::fix_overlay() {
  Main_Menu[41].label("Hide O&verlays");
...
void toggle_overlays(Fl_Widget *,void *) {
  ...
  if (overlays_invisible) Main_Menu[41].label("Show O&verlays");
  else Main_Menu[41].label("Hide O&verlays");
...
//
// End of "$Id: Fl_Window_Type.cxx 7152 2010-02-26 13:40:10Z matt $".
//
