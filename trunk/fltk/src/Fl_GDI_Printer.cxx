//
// "$Id: Fl_GDI_Printer.cxx 7522 2010-04-18 06:57:37Z manolo $"
//
...
extern "C" BOOL DPGetDefaultPrinter(LPTSTR pPrinterName, LPDWORD pdwBufferSize);
...
// returns 0 iff OK
{
  ...
  if(ask_for_printer()){
  	...
  	char pPrinterName[1024];
  	DWORD pPrinterNameSize = sizeof(pPrinterName);
  	if(!DPGetDefaultPrinter(pPrinterName, &pPrinterNameSize))
  		err = 1;
	// Get a device context for the printer.
	hPr = CreateDC(NULL, pPrinterName, NULL, NULL);
  }
  if (hPr != NULL) {
	  strcpy (docName, "FLTK");
...
//
// End of "$Id: Fl_GDI_Printer.cxx 7522 2010-04-18 06:57:37Z manolo $".
//
